...
const Information = ({userDetails, setContactInfo, nextStep}) => {
    ...
    let initialValues = {
        firstName: userDetails.user.firstName,
                ...
                country: userDetails.user.country ? userDetails.user.country : 'Pakistan',
                province: userDetails.user.province ? userDetails.user.province : 'Punjab',
                email: userDetails.user.email,
                city: userDetails.user.city ? userDetails.user.city : '',
                address: userDetails.user.address ? userDetails.user.address : '',
